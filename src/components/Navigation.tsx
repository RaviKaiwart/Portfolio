        ...
        <div className="hidden lg:flex items-center gap-2 bg-white/5 backdrop-blur-xl p-1.5 rounded-full border border-white/10 shadow-2xl">
          {navItems.map((item) => (
            <button
              ...
              className={`px-6 py-2.5 rounded-full text-[10px] font-black uppercase tracking-widest transition-all duration-300 relative ${
                activeSegment === item.id ? 'text-black' : 'text-white/60 hover:text-white'
              }`}
            >
